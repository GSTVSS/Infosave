...
$id_cliente = mysqli_real_escape_string($conn, $_GET['id_colaborador']);

$altera_cliente = "DELETE FROM colaboradores WHERE id_colaborador='$id_cliente'";
...
if($resposta){
    ...
    $_SESSION['success'] = "<div class='alert alert-success alert-dismissible fade show text text-center mb-0' role='alert'>
                                ...
                                <strong> COLABORADOR EEXCLUÍDO COM SUCESSO &nbsp; <i class='far fa-smile-wink fa-2x'></i> </strong> 
    ...
    $_SESSION['error'] = "<div class='alert alert-danger alert-dismissible fade show text text-center mb-0' role='alert'>
                                ...
                                <strong> NÃO FOI POSSÍVEL EXCLUIR O COLABORADOR &nbsp; <i class='fas fa-grin-squint-tears fa-2x'></i> </strong> 
                                    <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
                                <span aria-hidden='true'>&times;</span>
                                </button>

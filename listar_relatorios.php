...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-2 bg-warning  justify-content-between p-3 d-flex">
            <button type="button" class="btn btn-sm btn-dark " data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#cadCliente">CADASTRAR RELATORIO</button>
        </div>
    </div>
</div>

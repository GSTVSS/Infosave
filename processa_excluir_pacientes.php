...
$id_cliente = mysqli_real_escape_string($conn, $_GET['id_paciente']);

$altera_cliente = "DELETE FROM pacientes WHERE id_paciente='$id_cliente'";
...
if($resposta){
    ...
    $_SESSION['success'] = "<div class='alert alert-success alert-dismissible fade show text text-center mb-0' role='alert'>
                                ...
                                <strong> PACIENTE EEXCLUÍDO COM SUCESSO &nbsp; <i class='far fa-smile-wink fa-2x'></i> </strong> 
